...
class Coordinator:
    ...
    def load_state(self) -> bool:
        ...
        for tx_dict in dag_data["transactions"]:
            ...
            # The hash is derived from the payload including the original
            # timestamp; restoring it keeps transaction identity (and thereby
            # tips, confirmations and mint-replay protection) stable across
            # restarts.
